										...
										echo "
											...
											<form method='POST' enctype='multipart/form-data' action='admin-editslideshow2.php?adminEmail=".$adminEmail."&role=".$role."&slideshowID=".$slideshowID."'>
												<table id='formtable'>
													...
													<tr>
														<td><b>*Caption:</b></td>
														<td><input type='text' name='slideshowCaption' class='forminput' placeholder='Title...' value='$slideshowCaption'></td>
													</tr>
													<tr>
														<td><b>*Slideshow Image:</b></td>
															<td><p><input type='file' name='slideshowImg'>Old picture: <img src='$slideshowImg' alt='' height='50px' width='120px'></p>*PNG/JPG/JPEG file only.</td>
													</tr>
													<tr>
