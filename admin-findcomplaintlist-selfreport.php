							...
							include 'connection.php';
								...
								if(empty($complaintStatus) || empty($serviceCategory)){
									if(empty($serviceCategory)){
										$complaintsquery = dbConn()->prepare("SELECT * FROM complaints where complaintStatus LIKE '%".$complaintStatus."%'");
										$complaintsquery->execute();
									}elseif(empty($complaintStatus)) {
										$complaintsquery = dbConn()->prepare("SELECT * FROM complaints where serviceCategory LIKE '%".$serviceCategory."%'");
										$complaintsquery->execute();
									}else{
									...
									$complaintsquery = dbConn()->prepare("SELECT * FROM complaints where complaintStatus LIKE '%".$complaintStatus."%' AND serviceCategory LIKE '%".$serviceCategory ."%'");
									$complaintsquery->execute();
								}else {
									echo "<p><b>Result:</b> There are no results were found.</p>
									<p><input id='backBtn' class='button' type='button' name='back' value='Back' onclick='goBack()'></p>
